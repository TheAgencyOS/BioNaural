...
struct InsightsView: View {
    ...
    private var bodyRightNowSection: some View {
    ...
    private var sessionImpactSection: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.md) {
    ...
    private var sessionsPerWeekCard: some View {
        NavigationLink {
            TrendsView()
        } label: {
            ZStack(alignment: .topLeading) {
    ...
    private func sleepStageAccessibilityLabel(stages: [SleepStage]) -> String {
